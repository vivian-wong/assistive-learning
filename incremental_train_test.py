...
################ TRAINING ########
# change data file to both medAL_all
delta_epochs=35
training_sizes = [0,30,35,45,70,100,200,400,800,1600,2600,3500] # do only 0-1600 only. evaluate on 2600-3500
...
#                    last_img = training_sizes[i+1]
#                    )
#             shutil.move("weights/best.pt", "weights/{0}_{1}_e{2}.pt".format(training_sizes[i],training_sizes[i+1], epochs))
        if i <6:
            epochs += delta_epochs
            print(epochs)
        else:
            ...
            train(cfg='cfg/yolov3-spp.cfg',
                    ...
                    num_workers=4,
                    transfer=False,
                    first_img=training_sizes[0],
                    last_img = training_sizes[i+1]
                    )
            shutil.move("weights/best.pt", "weights/{0}_{1}_e{2}.pt".format(training_sizes[0],training_sizes[i+1],epochs))
